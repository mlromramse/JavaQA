...
/**
 * OLInformixDialect (c) 2007 - Open Lab - www.open-lab.com
 */
public class OLInformixDialect  extends Dialect {

  /**
   * Creates new <code>OLInformixDialect</code> instance. Sets up the JDBC /
   * Informix type mappings.
   */
  public OLInformixDialect() {
    super();
    ...
    registerColumnType(Types.LONGVARCHAR, "LVARCHAR($l)"); //  better than CLOB
    ...
    registerHibernateType(Types.TIME, "DATETIME YEAR TO FRACTION(5)");
