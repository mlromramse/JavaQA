<%@ page import="com.QA.Question,
                 ...
                 org.jblooming.waf.settings.I18n, org.jblooming.waf.view.PageState, java.io.IOException, java.text.SimpleDateFormat, java.util.Locale" %><%@ page pageEncoding="UTF-8" %><%!
...
%><% // ------------------------------------------------------ REAL PAGE STARTS HERE --------------------------------------------------------------------------------------
  ...
  channelBuilderStart(out, I18n.g("QA_APP_NAME")+" RSS", ApplicationState.serverURL);
